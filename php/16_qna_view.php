<?php
  ...
  $qna_id = $_GET['id'];
  updateViews('qna', $qna_id);
  $qna_result = printQnA($qna_id);
?>
<!DOCTYPE html>
<html lang="ko">
  <head>
  ...
  <body>
    <form name="qna_view" action="#" method="post">
      <div id="wrap">
        <!-- header -->
        <div id="header">
        ...
        <div class="board_wrap">
          ...
          <div class="board_view_wrap">
            <div class="board_view">
              <div class="title"><?=$qna_result['title']?></div>
              <div class="info">
                <dl>
                  <dt>번호</dt>
                  <dd><?=$qna_result['num']?></dd>
                </dl>
                <dl>
                  <dt>작성자</dt>
                  <dd><?=$qna_result['nickname']?></dd>
                </dl>
                <dl>
                  <dt>작성일</dt>
                  <dd><?=$qna_result['created']?></dd>
                </dl>
                <dl>
                  <dt>조회</dt>
                  <dd><?=$qna_result['views']?></dd>
                </dl>
              </div>
              <div class="cont"><?=$qna_result['contents']?></div>
            </div>
            <div class="bt_wrap">
              <a href="16_qna.html" class="on">목록</a>
              <!-- <a href="#">수정</a> -->
            </div>
          </div>
        </div>
