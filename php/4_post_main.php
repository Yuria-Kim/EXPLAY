...
<html lang="en">
  ...
  <body>
    <!-- search.php와 연결하여 검색 처리 -->
    <form action="0_search.php" method="post" name="post_main">
      <div id="wrap">
        <!-- header -->
        <div id="header">
          ...
          <div id="h_main">
            <div class="main1">
              <div class="title"><a href="index.php">explay(title)</a></div>
        ...
        <div id="body">
          <!-- 검색 -->
          <br /><br /><br />
          <!-- 1029 hidden input 추가 -->
          <input type="hidden" name="search" value="search_post">
          <div class="post">
            <p><br />Posts</p>
            <br />
            <!--소주제 토글-->
            <div class="tag">
              ...
              <!-- 검색은 게시글 제목에서 검색 -->
              <button type="submit" class="searching">검색</button>
            </div>
            <br /><br /><br />

            <!-- 1029 새글쓰기 링크 6_po_write.php로 변경 -->
            <button
              id="post_writer"
              onclick="location.href='6_po_write.php'; return false;"
            >
              새글쓰기
            </button>
            <hr />
            ...
            <main id="p_main">
              ...
              <?php
                foreach($post as $postcode){
                  $data = printImg('post', $postcode);
                  $img = $data['img'];
                  $code = $data['code'];

                  echo "<box class='imgbox'>
                          <a href='5_po_now_read1029.php?id={$code}' class='btn_open' onClick='javascript:popOpen();'>
              ...
              <!-- // <box class="imgbox"> -->
                <!--팝업 오픈 버튼-->
                <!-- <div class="btn_box">
                  <a href="5_po_now_read1029.php?id=3" class="btn_open" onClick="javascript:popOpen();">
                    <p>posting img 1</p>
                  </a>
                </div> -->
                <!--// 팝업 오픈 버튼-->
              <!-- </box>
              <box class="imgbox">posting img 2</box>
              <box class="imgbox">posting img 3</box> -->
            </main>
            <br />
            <hr />
        ...
        <div class="modal_wrap">
          <object
            data="5_po_now_read.html"
            type=""
            width="100%"
            height="100%"
          ></object>
          <!-- <div id="sub_wrap">
            <h2 id="po_read_title">#DB에서 불러온 포스트 title</h2>
            ...
            <div id="comm_photo">
                <box class="comm_photo_box">댓글에 포함할 이미지</box>
                <input type="file" class="comm_photo_added" multiple>
            </div>

            <div class="po_read_btn">
                <input type="text" placeholder="댓글을 남겨주세요" size="100">
